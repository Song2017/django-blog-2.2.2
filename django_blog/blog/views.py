...
class IndexView(ListView):
    ...
    def pagination_data(self, paginator, page, is_paginated):
        ...
        # 标示第 1 页页码后是否需要显示省略号, 标示最后一页页码前是否需要显示省略号
        left_has_more, right_has_more = False, False

        # 标示是否需要显示第 1 页的页码号,标示是否需要显示最后一页的页码号
        ...
        # 获得用户当前请求的页码号
        page_number, total_pages = page.number, paginator.num_pages
...
def archives(request, year, month):
    # 函数的参数列表: Django 要求我们把点替换成了两个下划线，即 created_time__year
